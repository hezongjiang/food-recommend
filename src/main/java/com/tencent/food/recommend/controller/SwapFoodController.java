...
public class SwapFoodController {
     ...
     */
    @GetMapping("list")
    public ResultData<SwapFoodListResponse> list(@RequestHeader(name = "openid") String openId,
...
//            配置swapfood
     ...
     */
    @GetMapping("detail")
    public ResultData<SwapFoodDetailResponse> detail(@RequestHeader(name = "openid") String openId,
